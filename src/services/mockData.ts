...
export const mockCatalog: CatalogEntry[] = [
  ...
  createCatalogEntry({
    ...
    line1: '1 37849U 11053A   24111.17242769  .00000130  00000+0  93553-4 0  9994',
    line2: '2 37849  99.1713 171.9748 0013460  81.6199 278.6427 14.12414659642468',
    apogeeKm: 870,
    perigeeKm: 853,
    inclinationDeg: 99.2,
    periodMinutes: 101.9,
...
export const mockConjunctions: ConjunctionRecord[] = [
  ...
  },
  {
    ...
    primary: { name: 'NOAA 19', catalogNumber: 37849 },
