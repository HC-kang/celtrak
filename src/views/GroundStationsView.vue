...
<template>
  <div class="page-stack station-ops">
    ...
    <PanelCard title="Conjunction Dashboard" subtitle="SOCRATES risk screening">
      <template #actions>
    ...
    <PanelCard title="Decay Predictions" subtitle="Catalog decay watch">
      <div class="stack-list">
        <article
    ...
    <PanelCard title="Scheduled Events" subtitle="User timeline">
      <div class="form-grid">
        ...
        <button class="button" type="button" @click="submitEvent()">이벤트 저장</button>
      </div>
      <EventTimeline :events="store.upcomingEvents" :satellite-lookup="memberLookup" @remove="store.deleteEvent" />
    </PanelCard>

    <PanelCard title="Settings" subtitle="Runtime preferences">
      ...
      <div class="stack-list">
        <article v-if="store.updateAvailable" class="stack-list__item stack-list__item--accent">
          ...
          <button class="button" type="button" @click="store.applyUpdate()">업데이트 적용</button>
        </article>
      </div>
    </PanelCard>

    <PanelCard title="Backup & Restore" subtitle="Workspace JSON">
      <div class="form-grid">
        <button class="button" type="button" @click="exportWorkspace()">현재 워크스페이스 export</button>
        ...
        <div class="toolbar">
          <button class="button" type="button" @click="importWorkspace('merge')">Merge import</button>
          <button class="button button--ghost" type="button" @click="importWorkspace('replace')">Replace import</button>
        </div>
